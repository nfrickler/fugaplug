...
// constructor
FugaVideo::FugaVideo(std::string in_ip, int in_firstport) {
...
// start pipeline
void FugaVideo::start(int winid) {

    cout << "FugaVideo: winid: " << winid << endl;
...
//    QApplication::syncX(); // x11 only
    ...
    cout << "FugaVideo: winid done: " << winid << endl;
